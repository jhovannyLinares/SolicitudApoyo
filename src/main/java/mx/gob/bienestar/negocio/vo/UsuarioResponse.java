...
public class UsuarioResponse {
	...
	public String toString() {
		return "UsuarioResponse [idPersonal=" + idPersonal + ", curp=" + curp + ", paterno=" + paterno + ", materno="
				+ materno + ", nombre=" + nombre + ", tipoContratacionId=" + tipoContratacionId + ", contratacion="
				+ contratacion + ", puestoId=" + puestoId + ", puesto=" + puesto + ", entidadID=" + entidadID
				+ ", entidad=" + entidad + ", claveRegion=" + claveRegion + ", region=" + region + ", cup=" + cup + "]";
	}
